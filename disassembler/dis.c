...
static unsigned *not_known(unsigned *c,char *s,int index);
static unsigned *type_1(unsigned *c,char *s,int index);
static unsigned *type_2(unsigned *c,char *s,int index);
static unsigned *type_3(unsigned *c,char *s,int index);
static unsigned *type_4(unsigned *c,char *s,int index);
static unsigned *type_5(unsigned *c,char *s,int index);
static unsigned *type_6(unsigned *c,char *s,int index);
static unsigned *type_7(unsigned *c,char *s,int index);
static unsigned *type_8(unsigned *c,char *s,int index);	/*	branch type instructions	*/
static unsigned *type_9(unsigned *c,char *s,int index);	/*	unlink	*/
static unsigned *type_10(unsigned *c,char *s,int index);	/*	rts	*/
static unsigned *type_11(unsigned *c,char *s,int index);	/*	LSR	*/
static unsigned *type_12(unsigned *c,char *s,int index);	/*	EXT	*/
static unsigned *type_13(unsigned *c,char *s,int index);	/*	CMPI	*/
static unsigned *type_14(unsigned *c,char *s,int index);	/*	ABCD	*/
static unsigned *type_15(unsigned *c,char *s,int index);	/*	CLR		*/
static unsigned *type_16(unsigned *c,char *s,int index);	/*	chk		*/
static unsigned *type_17(unsigned *c,char *s,int index);	/*	DBcc	*/
static unsigned *type_18(unsigned *c,char *s,int index);	/*	EXG		*/
static unsigned *type_19(unsigned *c,char *s,int index);	/*	CMPM	*/
static unsigned *type_20(unsigned *c,char *s,int index);	/*	BTST #	*/
static unsigned *type_21(unsigned *c,char *s,int index);	/*	BTST	*/
static unsigned *type_22(unsigned *c,char *s,int index);	/*	moveq	*/
static unsigned *type_23(unsigned *c,char *s,int index);	/*	movem	*/
static unsigned *type_24(unsigned *c,char *s,int index);	/*	TRAP	*/
static unsigned *type_25(unsigned *c,char *s,int index);	/*	STOP	*/
static unsigned *type_26(unsigned *c,char *s,int index);	/*	MOVE SR	*/
static unsigned *type_27(unsigned *c,char *s,int index);	/*	ANDI SR	*/
static unsigned *type_28(unsigned *c,char *s,int index);	/*	move USP	*/
static unsigned *type_29(unsigned *c,char *s,int index);	/*	MOVEP	*/
static unsigned *effective_address();
static unsigned *effective_address(unsigned *a,char *s,unsigned ea,int index,int op_mode);
...
void *dis(void *c,char *s)
{
	...
	*/
	...
	if(loop)
		...
		return((void *)(*table[table_entry].d_funct)((unsigned *)c,s,table_entry));
}

static unsigned *type_29(unsigned *c,char *s,int index)
{
...
static unsigned *type_28(unsigned *c,char *s,int index)
{
	sprintf(s,table[index].op,(long)c,adr_regs[*c & 0x7]);
	return(++c);
}

static unsigned *type_27(unsigned *c,char *s,int index)
{
	/*	ANDI SR	*/
	long adr;
/*	int data;	*/
	...
	adr = (long)c++;
	sprintf(s,table[index].op,adr,*c);
	return(++c);
}

static unsigned *type_26(unsigned *c,char *s,int index)
{
	/*	move sr	*/
	long adr;
	int source;
...
static unsigned *type_25(unsigned *c,char *s,int index)
{
	/*	STOP	*/
	long adr;

	adr = (long)c++;
	sprintf(s,"%6lx   %s   #$%x",adr,table[index].op,*c);
	return(++c);
}

static unsigned *type_24(unsigned *c,char *s,int index)
{
	/*	trap	*/
	int vector;

	sprintf(s,"%6lx   %s   #$%x",(long)c,table[index].op,*c & 0x0f);
	return(++c);
}
	
static unsigned *type_23(unsigned *c,char *s,int index)
{
	/*	movem	*/
	long adr;
	unsigned reg_mask;
...
static unsigned *type_22(unsigned *c,char *s,int index)
{
	/*	moveq	*/
	long adr;
	unsigned dest_reg;
...
static unsigned *type_21(unsigned *c,char *s,int index)
{
	long adr;
	unsigned dest_reg;
	unsigned source;
	...
	adr = (long)c;
	dest_reg = (*c & 0x0e00) >> 9;	/*	get destination reg	*/
	source = *c & 0x3f;				/*	this is an effective address	*/
...
static unsigned *type_20(unsigned *c,char *s,int index)
{
...
static unsigned *type_19(unsigned *c,char *s,int index)
{
...
static unsigned *type_18(unsigned *c,char *s,int index)
{
...
static unsigned *type_17(unsigned *c,char *s,int index)
{
...
static unsigned *type_16(unsigned *c,char *s,int index)
{
...
static unsigned *type_15(unsigned *c,char *s,int index)
{
...
static unsigned *type_14(unsigned *c,char *s,int index)
{
...
static unsigned *type_13(unsigned *c,char *s,int index)
{
...
static unsigned *type_12(unsigned *c,char *s,int index)
{
...
static unsigned *type_11(unsigned *c,char *s,int index)
{
...
static unsigned *type_10(unsigned *c,char *s,int index)
{
...
static unsigned *type_9(unsigned *c,char *s,int index)
{
...
static unsigned *type_8(unsigned *c,char *s,int index)
{
...
static unsigned *type_3(unsigned *c,char *s,int index)
{
	...
	dest_reg = (*c & 0x0e00) >> 9;	/*	get destination reg	*/
	source = *c & 0x3f;				/*	this is an effective address	*/
	op_mode = (*c & 0x01c0) >> 6;	/*	get op mode	*/
...
static unsigned *type_1(unsigned *c,char *s,int index)
{
	...
	adr = (long)c;
	the_reg = *c & 0x07;	/*	get register number	*/
